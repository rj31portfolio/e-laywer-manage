...
<head>
    ...
    <title><?php echo SITE_NAME; ?> - <?php echo $pageTitle ?? 'Legal Consultation Platform'; ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo SITE_URL; ?>/lawyers.php">Find Lawyers</a>
                    </li>
                    <?php if ($auth->isLoggedIn()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/<?php echo $auth->getUserRole(); ?>/dashboard.php">Dashboard</a>
                        </li>
                    <?php endif; ?>
                </ul>
                <ul class="navbar-nav">
